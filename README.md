...
```sh
# on Linux and Mac
git clone https://github.com/esodesod/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```


```
# on Windows
git clone https://github.com/esodesod/kickstart.nvim.git %userprofile%\AppData\Local\nvim\ 
```
